...
namespace ComponentsLife.Controllers
{
    public class EnginesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,notes,currentKilometers,maxKilometers")] Engine engine)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,notes,currentKilometers,maxKilometers")] Engine engine)
        {
            if (ModelState.IsValid)
            {
