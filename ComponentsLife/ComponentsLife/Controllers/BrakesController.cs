...
namespace ComponentsLife.Controllers
{
    public class BrakesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,notes,currentKilometers,maxKilometers")] Brakes brakes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,notes,currentKilometers,maxKilometers")] Brakes brakes)
        {
            if (ModelState.IsValid)
            {
